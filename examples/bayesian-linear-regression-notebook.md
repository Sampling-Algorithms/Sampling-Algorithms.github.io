...
This example includes a runnable notebook and companion resources.
...
- Read companion page: [Bayesian Linear Regression]({{ site.baseurl }}/_examples/Bayesian/linear-regression)
